-- Disable the new predecessor lock port. Retain the ordering repair and all
-- historical journal/feedback recovery commands and evidence; no unsafe unwrap.
begin;
...
revoke execute on function shareholder_register_filing.lock_correction_predecessor_v1(uuid,uuid,integer,text)
