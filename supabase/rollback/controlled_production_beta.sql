...
revoke all on function public.manage_production_pilot_entitlement(uuid, uuid, uuid, integer, text, boolean, timestamptz, timestamptz, text) from public, anon, authenticated, service_role;
...
drop function if exists public.manage_production_pilot_entitlement(uuid, uuid, uuid, integer, text, boolean, timestamptz, timestamptz, text);
