...
`backend_system.annual_notification_receipts` is technical event-delivery state,
...
The separate store owner is for migrations, with no runtime binding.
