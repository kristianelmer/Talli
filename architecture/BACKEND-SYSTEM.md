...
The `owner-dividend-governance` workflow also serves
`/api/v1/corporate-governance/shareholder-loans`. Corporate governance owns the
supported policy and canonical record, verifies Documents evidence, and uses
only restricted Ledger and Banking public contracts for the atomic effects.
