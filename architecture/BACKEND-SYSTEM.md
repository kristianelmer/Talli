...
The `corporate-governance` workflow serves annual-close and owner-dividend
proposal, lifecycle, approval, signing, attestation, finalization and payment
routes plus `/api/v1/corporate-governance/shareholder-loans`. Corporate
