...
`/api/v1/shareholder-register-filings/archive-source/production` adds the complete production submission, feedback, and reconciliation archive. The original route retains its prior payload and storage dependencies so either backend/web deployment order remains readable.
...
<!-- architecture-inventory
{"technicalMigrations":["supabase/contract-migrations/20260902110000_corporate_governance_contract.sql","supabase/contract-migrations/20260905013000_billing_contract.sql","supabase/contract-migrations/20260909190955_shareholder_register_filing_contract.sql","supabase/contract-migrations/20260913172000_company_tax_settlement_cutover.sql","supabase/contract-migrations/20260913173000_company_tax_settlement_contract.sql","supabase/contract-migrations/20260914012503_company_tax_return_cutover.sql","supabase/contract-migrations/20260914012930_company_tax_return_contract.sql","supabase/contract-migrations/20260914200000_company_tax_return_expand.sql","supabase/contract-migrations/20260914201000_company_tax_return_read_contracts.sql","supabase/contract-migrations/20260914202000_company_tax_return_import_contract.sql","supabase/contract-migrations/20260914203000_company_tax_return_preparation_contracts.sql","supabase/migrations/0001_authenticated_workspace.sql","supabase/migrations/20260801090000_company_access_invitations.sql","supabase/migrations/20260808120000_company_access_cancellation_lifecycle.sql","supabase/migrations/20260826100000_company_access_onboarding.sql","supabase/migrations/20260826110000_company_year_admission.sql","supabase/migrations/20260827100000_ledger_capability.sql","supabase/migrations/20260827100500_ledger_writer_coordinators.sql","supabase/migrations/20260827101000_ledger_full_year_reconstruction.sql","supabase/migrations/20260827103000_ledger_corrections.sql","supabase/migrations/20260827104000_ledger_company_year_close.sql","supabase/migrations/20260827109000_ledger_opening_position_rebuild.sql","supabase/migrations/20260828100000_banking_capability.sql","supabase/migrations/20260828100500_banking_workflows.sql","supabase/migrations/20260828100600_banking_overlap_trigger_policy.sql","supabase/migrations/20260828102000_banking_connections.sql","supabase/migrations/20260828103000_marketing_funnel_measurement.sql","supabase/migrations/20260829070411_marketing_measurement_small_cell_threshold.sql","supabase/migrations/20260829074916_validation_observation_authority.sql","supabase/migrations/20260829080345_marketing_measurement_consent_proof.sql","supabase/migrations/20260830091341_case_bound_support_access.sql","supabase/migrations/20260830093000_current_legal_evidence.sql","supabase/migrations/20260902040000_corporate_governance_owner_dividend.sql","supabase/migrations/20260902053000_corporate_governance_advisor_cleanup.sql","supabase/migrations/20260902054500_corporate_governance_rls_initplan_cleanup.sql","supabase/migrations/20260902070000_corporate_governance_shareholder_loan.sql","supabase/migrations/20260902084230_corporate_governance_shareholder_loan_rls_initplan_cleanup.sql","supabase/migrations/20260902090000_corporate_governance_annual_close.sql","supabase/migrations/20260902095000_company_access_corporate_governance_identity.sql","supabase/migrations/20260902100000_corporate_governance_artifact_lifecycle.sql","supabase/migrations/20260902105000_corporate_governance_hosted_shape_parity.sql","supabase/migrations/20260904220000_corporate_governance_supported_events.sql","supabase/migrations/20260904223000_ledger_supported_event_reversals.sql","supabase/migrations/20260905003000_company_access_billing_owner_subject.sql","supabase/migrations/20260905010000_billing_capability.sql","supabase/migrations/20260906204352_annual_notification_receipts.sql","supabase/migrations/20260907153938_annual_checkout_observation.sql","supabase/migrations/20260909120610_authority_connections_capability.sql","supabase/migrations/20260909124946_backend_system_launch_signoffs.sql","supabase/migrations/20260909190548_shareholder_register_filing_capability.sql","supabase/migrations/20260909190905_shareholder_register_filing_cutover.sql","supabase/migrations/20260913171000_company_tax_settlement_expand.sql"]}
-->
...
The `company-tax-assessment-previews` composition exposes authenticated POST `/api/v1/company-tax/readiness-previews` and `/api/v1/company-tax/annual-estimate-previews` over Company Tax public pure contracts. It accepts caller-supplied immutable preview facts, performs no business-data read or mutation, and cannot attest durable source completeness or authorize filing. Annual and Billing retain their own decisions.
...
## Annual Accounts inactive expansion

Stage #153 inventories the last six generic filing families and declares private
Accounts successors without switching their writer. Backend System owns the
migration inventory, source-row hashes, quarantine, reconciliations and phase;
...
The generated web boundary and immutable source handoff are implemented; their
complete release evidence and stage-exit state are tracked in issue #153.
...
<!-- architecture-inventory
{"technicalMigrations":["supabase/contract-migrations/20260914112549_annual_accounts_filing_backend_binding.sql","supabase/rollback/20260914112549_annual_accounts_filing_backend_binding.sql","supabase/migrations/20260923090824_ledger_reporting_amendment_read.sql"]}
-->

### RF year-source persistence binding

```json
{"ports":["Rf1086YearSourcePersistence"],"adapterBindings":["Rf1086YearSourcePersistence=>talli_backend.adapters.postgres_shareholder_register_filing.PostgresShareholderRegisterFilingSession"],"adapterBindingOwners":["Rf1086YearSourcePersistence=>backend-system"],"adapterBindingModes":["Rf1086YearSourcePersistence=>verified request-scoped RF capability binding"]}
```

### RF full-year source capture

`ShareholderRegisterSourceWorkflow` composes Company Access, Documents, Corporate Governance and RF public contracts. It constructs trusted evidence internally after verifying original bytes and complete Governance enumeration. The internal workflow has no HTTP route or provider operation. Registered cash issuance and loss-covering reduction capture verify current independent register observations. Cash nominal increases remain unavailable until the Governance contract supports that variant.

### RF register observations and original-document retention

RF owns independent register observations and immutable correction lineages. The Documents-owned adapter locks each original metadata record and retains its reference in the same RF transaction; it returns no storage bytes and grants no filing authority.
...
## RF source intake and review

The `shareholder-register-filing` workflow composes
`talli_backend.application.shareholder_register_source_workflow` with Company
Access, Documents and Corporate Governance. The authenticated owner can capture
an independent register observation through
`/api/v1/shareholder-register-filings/register-observations`, capture a complete
year source through `/api/v1/shareholder-register-filings/year-sources`, and
generate a preview through `/api/v1/shareholder-register-filings/source-previews`.
Reading `/api/v1/shareholder-register-filings/source-previews/{previewId}`
rechecks current source evidence and original document bytes. The backend derives
verified identities and integrity metadata; request DTOs cannot supply trusted
verification claims. These additive routes do not authorize approval or Send.

`/api/v1/shareholder-register-filings/source-documents/{documentId}` exposes
verified metadata for a requested company’s source original to its current AS
owner. Original bytes remain private and the original income year is preserved.
Capture independently verifies that observation again. The separate route leaves
existing document response shapes unchanged for either deployment order.

`/api/v1/shareholder-register-filings/current-year-source` reads the current
retained source for its accepted AS owner and supplies an editable correction
draft. Review confirmations are reset and its exact predecessor is retained.
This read does not re-verify original bytes or authorize filing; correction
capture independently verifies the updated source and current owner evidence.

`/api/v1/shareholder-register-filings/source-intake-basis` returns typed current
company identity and the complete Governance reporting-year enumeration to the
accepted AS owner. It retains unresolved/corrected events, source and reporting
years, economics and exact original-document/register references with server
blockers. It performs no document download, capture or production authorization;
capture must recheck current owner evidence.


The `shareholder-register-source-approval` workflow binds full-year source
reviews and approvals under one company/year admission transaction. Its
`/api/v1/shareholder-register-filings/source-production-reviews` and
`/api/v1/shareholder-register-filings/source-production-approvals` routes compose
`talli_backend.application.shareholder_register_source_approval`. The workflow
verifies originals before taking the guard, rechecks all current source facts,
