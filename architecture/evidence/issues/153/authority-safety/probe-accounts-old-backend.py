...
import httpx
root=Path.cwd();private=Path(__file__).parent;base='5b74340ca75f215b43d754c6bf0fc49ef5974b0b';archive=private/'old-backend-5b-accounts-protocol';archive.mkdir(exist_ok=True)
...
try:
 ...
 for _ in range(100):
  ...
  try:
   if httpx.get(origin+'/health/live').status_code==200:break
