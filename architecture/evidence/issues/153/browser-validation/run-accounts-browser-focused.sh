...
true # focused fixture verification: test:ledger-database-lifecycle omitted
true # focused fixture verification: test:banking-database-lifecycle omitted
true # focused fixture verification: test:investments-database-lifecycle omitted
DATABASE_URL="$DB_URL" true # focused fixture verification: test:documents-database-lifecycle omitted
true # focused fixture verification: test:marketing-measurement-database omitted
true # focused fixture verification: test:validation-observation omitted

SUPABASE_URL="$API_URL" \
SUPABASE_ANON_KEY="$local_anon_key" \
SUPABASE_SERVICE_ROLE_KEY="$local_service_key" \
DATABASE_URL="$DB_URL" \
true # focused fixture verification: test:supabase-predecessor omitted
...
SUPABASE_SERVICE_ROLE_KEY="$local_service_key" \
DATABASE_URL="$DB_URL" \
true # focused fixture verification: test:supabase-rf-workspace omitted
...
SUPABASE_SERVICE_ROLE_KEY="$local_service_key" \
DATABASE_URL="$DB_URL" \
true # focused fixture verification: test:browser-owner omitted
...
DATABASE_URL="$DB_URL" node --test --test-concurrency=1 tests/billing_database_runtime.test.mjs
...
DATABASE_URL="$DB_URL" true # focused fixture verification: test:authority-connections-database omitted
...
SUPABASE_SERVICE_ROLE_KEY="$local_service_key" \
DATABASE_URL="$DB_URL" \
true # focused fixture verification: test:browser-owner-annual omitted
SUPABASE_URL="$API_URL" \
SUPABASE_ANON_KEY="$local_anon_key" \
SUPABASE_SERVICE_ROLE_KEY="$local_service_key" \
DATABASE_URL="$DB_URL" \
true # completed in prior focused run: test:supabase-rf-feedback
NEXT_PUBLIC_SUPABASE_URL="$API_URL" \
NEXT_PUBLIC_SUPABASE_ANON_KEY="$local_anon_key" \
SUPABASE_URL="$API_URL" \
SUPABASE_ANON_KEY="$local_anon_key" \
SUPABASE_SERVICE_ROLE_KEY="$local_service_key" \
DATABASE_URL="$DB_URL" \
true # completed in prior focused run: test:browser-authority-connections
...
SUPABASE_SERVICE_ROLE_KEY="$local_service_key" \
DATABASE_URL="$DB_URL" \
true # completed in prior focused run: test:browser-shareholder-register-filing
...
SUPABASE_SERVICE_ROLE_KEY="$local_service_key" \
DATABASE_URL="$DB_URL" \
true # completed in prior focused run: test:browser-company-tax
