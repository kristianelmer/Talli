...
### Community 1 - "Web Business Actions"
Cohesion: 0.06
Nodes (92): acceptBankTransactionSuggestion(), acceptWorkspaceInvitation(), acknowledgeFilingReviewComment(), activateBillingSubscription(), addFilingOverride(), addFilingReviewComment(), administerWorkspaceMembership(), approveCorporateDecisionFacts() (+84 more)

### Community 2 - "Repository Test Commands"
Cohesion: 0.02
...
### Community 3 - "Web UI Components"
Cohesion: 0.05
Nodes (67): BannerProps, BannerVariant, ICON, Button(), buttonClass(), ButtonProps, ButtonSize, ButtonVariant (+59 more)

### Community 4 - "Action Form Components"
Cohesion: 0.05
Nodes (49): ACTION_SLUGS, ActionsHubProps, metadata, GoogleSignInButton(), ActionPreview(), ActionPreviewProps, formatKr(), krFormatter (+41 more)

### Community 5 - "Architecture Enforcement"
Cohesion: 0.05
...
### Community 6 - "Corporate Decision Facts"
Cohesion: 0.05
Nodes (69): BoardParticipantDraft, DividendShareholder, OwnerDividendDraftIds, OwnerDividendWizard(), Props, AnnualAccountsPayloadForCorporateClose, AnnualDataForCorporateClose, buildAnnualCloseBasis() (+61 more)

### Community 7 - "Corporate Document Engine"
Cohesion: 0.08
...
### Community 8 - "Company Access Administration"
Cohesion: 0.06
Nodes (54): InvitationAcceptancePage(), InvitationAcceptancePageProps, AcceptedMembershipCompanyPresentation, CompanyAccessPresentation, CompanyRegistryPresentation, presentCompanyAccessContext(), presentCompanyAccessRecord(), presentCompanyRegistry() (+46 more)
...
Cohesion: 0.06
Nodes (54): assertAuthorityOperationIntent(), assertSystembrukerCallbackOperationIntent(), AUTHORITY_CONFIRMATION, AUTHORITY_OPERATION, authorityFetch(), AuthorityOperationEnvironment, authorityOperationEnvironmentFailureCode(), AuthorityOperationError (+46 more)

### Community 11 - "Annual Workspace UI"
Cohesion: 0.06
Nodes (42): ActionsHubPage(), BillingPage(), PLAN_ORDER, productionBillingGate(), buildCancellationEvidence(), buildCancellationLifecycle(), buildDeletionCompletionUpdate(), CancellationEvidence (+34 more)
...
### Community 13 - "RF1086 Submission"
Cohesion: 0.07
Nodes (51): PythonRuntimeOptions, resolveTalliPythonBinary(), amount(), buildNoActivityHovedskjema(), buildNoActivityRf1086Case(), buildNoActivityUnderskjema(), invalidNoActivityCase(), noActivityPreview() (+43 more)

### Community 14 - "Annual Filing Readiness"
Cohesion: 0.06
Nodes (41): FilingHubPage(), FilingHubProps, archiveReference(), buildOwnerFilingPresentation(), COMPANY_TAX_PENDING_FEEDBACK_COPY, obligationFilingString(), buildReadinessInput(), FILING_OBLIGATIONS (+33 more)
...
Cohesion: 0.29
Nodes (42): BaseHTTPMiddleware, AcceptCompanyInvitationRequest, AdministerCompanyMembershipRequest, CompanyAccessRecordResponse, CompanyAgreementAcceptanceRequest, CompanyAgreementAcceptanceResponse, CompanyCancellationListResponse, CompanyCancellationResponse (+34 more)
...
### Community 19 - "OpenAPI Baseline Contract"
Cohesion: 0.05
Nodes (45): content, description, headers, content, description, headers, content, description (+37 more)

### Community 20 - "Company Access Policies"
Cohesion: 0.12
Nodes (14): _authentication_required(), _company_access_not_found(), _company_access_unavailable(), _company_registry_unavailable(), CompanyAccessError, CompanyAccessService, _invitation_body(), _onboarding_response() (+6 more)
...
### Community 22 - "OpenAPI Contract Schema"
Cohesion: 0.05
Nodes (46): const, title, type, title, type, title, type, properties (+38 more)

### Community 23 - "Annual Workspace UI"
Cohesion: 0.07
Nodes (30): AnnualOverview(), AnnualWorkspaceShell(), roleLabel, ContextRail(), description, ObligationRow(), SubmissionRecords, SubmissionReview() (+22 more)

### Community 24 - "Annual Close Fixture"
Cohesion: 0.05
...
### Community 25 - "RF1086 Submission"
Cohesion: 0.07
Nodes (30): adminCostAccounts, AdminCostCategory, assertBankTransactionMatchesCost(), buildAdminCostLedgerLines(), parseBankCsv(), ParsedBankTransaction, roundMoney(), splitCsvLine() (+22 more)

### Community 26 - "Annual Workspace UI"
Cohesion: 0.05
...
### Community 27 - "Cancellation Actions"
Cohesion: 0.08
Nodes (35): isIndeterminateCancellationError(), PendingCancellationOperation, pendingCancellationOperationForError(), clearPendingCancellationOperation(), loadPendingCancellationOperation(), preservePendingCancellationOperation(), valid(), operatorAuthorityCopy (+27 more)
...
### Community 29 - "Onboardinggatewaystub"
Cohesion: 0.12
Nodes (22): BrregCompanyRegistryAdapter, BrregCompanyRegistryConfiguration, BaseHTTPRequestHandler, CompanyAgreementAcceptanceGatewayCommand, CompanyOnboardingGatewayCommand, Self, CompanyAgreementAcceptanceGatewayCommand, CompanyOnboardingGatewayCommand (+14 more)

### Community 30 - "Supabase Company Adapter"
Cohesion: 0.10
...
### Community 31 - "Supabase Company Adapter"
Cohesion: 0.09
Nodes (20): FinalizeCompanyDeletionGatewayCommand, RequestCompanyCancellationGatewayCommand, ResumeCompanyCancellationGatewayCommand, ReviewCompanyDeletionGatewayCommand, AdministerMembershipGatewayCommand, CompanyAccessCommandModel, CompanyAccessGateway, CompanyCancellation (+12 more)

### Community 32 - "Contract Boundary Checks"
Cohesion: 0.08
...
### Community 33 - "Corporate Document Workflow"
Cohesion: 0.08
...
### Community 34 - "Dependency Evidence Schema"
Cohesion: 0.06
...
### Community 38 - "Filing Release Controls"
Cohesion: 0.09
Nodes (27): issueTitleByCode, obligationDescription, ObligationRecords, ObligationWorkspace(), authorityObligationLabel(), authorityObligations, AuthorityPermission, AuthorityPermissionGate (+19 more)

### Community 39 - "Authority Test Evidence"
Cohesion: 0.10
Nodes (28): AnnualAccountsAuthorityTestRunImportInput, authorityTestEvidenceGate, AuthorityTestEvidenceGateStatus, authorityTestEvidenceGateStatusLabel(), AuthorityTestRun, AuthorityTestRunEnvironment, AuthorityTestRunInput, AuthorityTestRunStatus (+20 more)
...
### Community 41 - "Filing Submission Core"
Cohesion: 0.14
...
### Community 42 - "RF1086 TT02 Evidence"
Cohesion: 0.06
...
### Community 43 - "RF1086 Production"
Cohesion: 0.09
...
### Community 44 - "Company Access API"
Cohesion: 0.11
Nodes (27): Adapter, AcceptInvitationGatewayCommand, company_access_adapter(), _company_access_record(), _company_record_values(), company_registry_adapter(), CompanyAccessModel, CompanyAccessRecord (+19 more)
...
### Community 51 - "Company Tax Fixture"
Cohesion: 0.07
...
### Community 62 - "Backend System Manifest"
Cohesion: 0.07
...
### Community 63 - "Owner Action Navigation"
Cohesion: 0.12
...
### Community 64 - "Bank Provider Port"
Cohesion: 0.10
...
### Community 65 - "RF1086 Production Tests"
Cohesion: 0.11
Nodes (13): documentStorageKey(), rf1086FeedbackFileName(), rf1086FeedbackStorageKey(), validateDocumentUpload(), createRf1086FeedbackArtifactRecorder(), FeedbackPersistenceInput, FeedbackPersistenceService, persistenceError() (+5 more)

### Community 66 - "Maskinporten Integration"
Cohesion: 0.13
Nodes (22): base64UrlJson(), buildMaskinportenGrant(), BuildMaskinportenGrantInput, endpointFor(), ENDPOINTS, FetchLike, MaskinportenEnvironment, MaskinportenGrant (+14 more)
...
### Community 69 - "RF1086 Domain Model"
Cohesion: 0.16
...
### Community 70 - "Annual Accounts Authority"
Cohesion: 0.11
...
### Community 71 - "Annual Workspace UI"
Cohesion: 0.18
...
### Community 72 - "Company Access Recovery"
Cohesion: 0.09
...
### Community 73 - "Supabase Adapter Contract"
Cohesion: 0.08
...
### Community 76 - "Company Tax Evidence"
Cohesion: 0.08
...
### Community 77 - "Share Lot Allocation"
Cohesion: 0.13
...
### Community 78 - "Company Access Backend Tests"
Cohesion: 0.15
...
### Community 79 - "Supabase Adapter Contract"
Cohesion: 0.18
...
### Community 80 - "Company Access Module"
Cohesion: 0.08
...
### Community 81 - "Company Access Module Docs"
Cohesion: 0.10
...
### Community 82 - "Company Context API Contract"
Cohesion: 0.08
Nodes (23): additionalProperties, required, title, type, additionalProperties, required, title, type (+15 more)

### Community 83 - "System Boundary Module"
Cohesion: 0.09
...
### Community 84 - "Company Tax Return"
Cohesion: 0.21
...
### Community 85 - "Owner Mfa Transition.test.mjs"
Cohesion: 0.13
...
### Community 91 - "Dividend Tests"
Cohesion: 0.09
Nodes (21): case_id, company, address, city, contact_email, income_year, name, org_number (+13 more)

### Community 92 - "Mismatched Share Count Tests"
Cohesion: 0.09
Nodes (21): case_id, company, address, city, contact_email, income_year, name, org_number (+13 more)

### Community 93 - "No Activity Tests"
Cohesion: 0.09
Nodes (21): case_id, company, address, city, contact_email, income_year, name, org_number (+13 more)

### Community 94 - "Share Sale Tests"
Cohesion: 0.09
Nodes (21): case_id, company, address, city, contact_email, income_year, name, org_number (+13 more)

### Community 95 - "Stiftelse Tests"
Cohesion: 0.09
Nodes (21): case_id, company, address, city, contact_email, income_year, name, org_number (+13 more)

### Community 96 - "Stiftelse Two Founders Tests"
Cohesion: 0.09
Nodes (21): case_id, company, address, city, contact_email, income_year, name, org_number (+13 more)

### Community 97 - "Legacy Facade Baseline Audit"
Cohesion: 0.11
...
### Community 100 - "Holding Accounting Core"
Cohesion: 0.19
...
### Community 101 - "Annual Filing Readiness"
Cohesion: 0.17
Nodes (17): accountBalance(), accountCreditBalance(), annualAccountsPayloadFeedback, AnnualAccountsPayloadField, annualFullTimeEquivalentsValue(), block(), buildAnnualAccountsPayload(), debitTotal() (+9 more)

### Community 102 - "Company Tax Return Authority Test"
Cohesion: 0.18
...
### Community 103 - "Unsupported Group Contribution Tests"
Cohesion: 0.10
...
### Community 105 - "Corporate Document Readiness"
Cohesion: 0.17
Nodes (16): aarsregnskapIssues(), aksjonaerregisterIssues(), AnnualReadinessIssue, AnnualReadinessIssueLevel, AnnualReadinessSnapshot, AnnualReadinessStatus, block(), commonReadinessIssues() (+8 more)

### Community 106 - "System User Flow Tests"
Cohesion: 0.12
...
### Community 107 - "Company Cancellation List API Contract"
Cohesion: 0.10
Nodes (20): items, title, type, additionalProperties, properties, required, title, type (+12 more)
...
### Community 111 - "Year End Interview"
Cohesion: 0.17
...
### Community 114 - "Production Filing Action Guide"
Cohesion: 0.12
...
### Community 115 - "Filing Release Controls"
Cohesion: 0.18
...
### Community 116 - "Action Form Components"
Cohesion: 0.16
Nodes (13): OnboardingPhase, OnboardingPresentationInput, selectOnboardingPhase(), shouldRedirectReturningOwner(), BankImportForm(), CompanyLookupForm(), newRow(), OpeningBalanceForm() (+5 more)

### Community 117 - "Owner Dividend Payment"
Cohesion: 0.16
...
### Community 118 - "RF1086 Authority Test"
Cohesion: 0.18
...
### Community 122 - "Annual Accounts Authority"
Cohesion: 0.21
Nodes (16): AnnualAccountsPayload, AnnualAccountsXmlInput, escapeXml(), financialValues(), OFFICIAL_ORIDS, officialFields(), OfficialTag, renderAnnualAccountsXml() (+8 more)

### Community 123 - "Supabase Data Access"
Cohesion: 0.17
...
### Community 124 - "Company Tax Return Xml"
Cohesion: 0.18
...
### Community 125 - "CONTEXT Documentation"
Cohesion: 0.14
...
### Community 129 - "Workspace Module"
Cohesion: 0.23
...
### Community 133 - "Company Access Backend Tests"
Cohesion: 0.16
...
### Community 138 - "Annual Workspace UI"
Cohesion: 0.18
...
### Community 139 - "Generate API Client"
Cohesion: 0.13
...
### Community 140 - "Production Filing Action Guide Tests"
Cohesion: 0.19
...
### Community 142 - "Compatibility Schema"
Cohesion: 0.14
...
### Community 144 - "Web Business Actions"
Cohesion: 0.19
...
### Community 145 - "Annual Accounts Authority"
Cohesion: 0.27
...
### Community 146 - "OpenAPI Contract Fields"
Cohesion: 0.14
Nodes (14): format, title, type, additionalProperties, properties, required, title, type (+6 more)

### Community 147 - "Talli Holding First Filing Assistant"
Cohesion: 0.20
...
### Community 148 - "PLAN Documentation"
Cohesion: 0.18
...
### Community 149 - "Use A Two Application Modular"
Cohesion: 0.19
...
### Community 150 - "Aksjonaerregisteroppgaven Phase Map"
Cohesion: 0.19
...
### Community 158 - "Production E2e Verification Evidence"
Cohesion: 0.15
...
### Community 159 - "RF1086 Controlled Beta Deployment Evidence"
Cohesion: 0.17
...
### Community 162 - "Accept Company Invitation API Contract"
Cohesion: 0.15
Nodes (13): additionalProperties, properties, required, title, type, format, title, type (+5 more)

### Community 163 - "Companyagreementacceptanceresponse"
Cohesion: 0.15
Nodes (13): additionalProperties, properties, required, title, type, const, title, type (+5 more)

### Community 164 - "Onboardinggatewaystub"
Cohesion: 0.24
Nodes (9): _address(), _optional_boolean(), _optional_string(), Bounded Brønnøysundregistrene adapter for company-access onboarding., _RejectRedirects, _required_string(), _unavailable(), _validated_origin() (+1 more)

### Community 165 - "Enforce The Architecture And Migrate"
Cohesion: 0.20
...
### Community 173 - "Corporate Document Local Rehearsal Evidence"
Cohesion: 0.20
...
### Community 177 - "Production Systemregister Operations"
Cohesion: 0.20
...
### Community 178 - "Filing Release Controls"
Cohesion: 0.17
...
### Community 179 - "System User Requests Database Runtime"
Cohesion: 0.20
Nodes (5): anonClient(), elevateToAal2(), requiredEnv, signIn(), totpCode()

### Community 180 - "Supabase Company Adapter"
Cohesion: 0.20
...
### Community 188 - "Production Approval"
Cohesion: 0.31
...
### Community 189 - "Shareholder Loan"
Cohesion: 0.25
...
### Community 190 - "System User Authority"
Cohesion: 0.20
...
### Community 191 - "Selected Company API Contract"
Cohesion: 0.18
Nodes (11): items, title, type, properties, required, title, type, companies (+3 more)

### Community 192 - "Run Customer Ready Gate"
Cohesion: 0.18
Nodes (7): previousIndex, revision, root, startedAt, taxSchemaRoot, temporaryRoot, transcript

### Community 193 - "Controlled Production Beta Actions Tests"
Cohesion: 0.18
Nodes (6): actions, operatorPage, ownerCopy, ownerPage, supabaseServer, systemUserFlow

### Community 194 - "RF1086 Feedback Schema Tests"
Cohesion: 0.22
Nodes (5): anonClient(), isLocalDatabase(), isLocalRuntime(), migrationName, signIn()

### Community 195 - "Action Form Components"
Cohesion: 0.20
Nodes (7): BankImport(), BankImportProps, Preview, PreviewRow, CATEGORY_KEYS, TransactionsPage(), TransactionsPageProps
...
### Community 205 - "System Boundary Public"
Cohesion: 0.22
...
### Community 211 - "Selected Company API Contract"
Cohesion: 0.22
Nodes (9): properties, required, title, type, items, title, type, invitations (+1 more)

### Community 212 - "CI Release Gate Tests"
Cohesion: 0.25
...
### Community 213 - "Enforce The Architecture And Migrate"
Cohesion: 0.25
...
### Community 234 - "Design Direction Rules"
Cohesion: 0.29
Nodes (7): narrative, donts, dos, keyCharacteristics, northStar, overview, rules

### Community 235 - "Annual Accounts Authority"
Cohesion: 0.33
Nodes (4): AnnualAccountsAuthorityError, prepareAnnualAccountsForSigning(), instanceResponse(), submittedInstanceResponse()

### Community 236 - "Annual Workspace UI"
Cohesion: 0.29
Nodes (3): authorityTestRunStatusLabel(), WorkspaceAuthorityTestRun, WorkspaceSubmission

### Community 237 - "Holdingswift Produktkrav"
Cohesion: 0.33
...
### Community 250 - "Canvas Color Tokens"
Cohesion: 0.33
Nodes (6): canonical, displayName, role, tonalRamp, canvas, colorMeta

### Community 251 - "Annual Workspace UI"
Cohesion: 0.47
Nodes (4): assertOperatorSearchAllowed(), buildOperatorSupportSummaries(), OperatorSupportSummary, SupportAuditRow

### Community 252 - "Migration()"
Cohesion: 0.53
...
### Community 253 - "Company Tax Feedback Persistence"
Cohesion: 0.47
...
### Community 254 - "Corporate Document Artifacts"
Cohesion: 0.47
...
### Community 282 - "Module Schema"
Cohesion: 0.50
Nodes (4): items, type, $ref, dependencies

### Community 283 - "RF1086 Code Evidence Register"
Cohesion: 0.50
...
### Community 285 - "Workspace Module"
Cohesion: 0.50
Nodes (3): Actor, FilingStatus, Workspace

### Community 286 - "Run Next"
Cohesion: 0.50
Nodes (3): child, nextCli, requireFromRepositoryRoot

### Community 288 - "Company Access Onboarding Cutover.test.mjs"
Cohesion: 0.67
Nodes (3): json(), read(), root

### Community 289 - "Controlled Production Beta Schema Tests"
Cohesion: 0.50
Nodes (3): bindingSql, rollback, sql

### Community 290 - "Root Workspace Dependency Graph Tests"
Cohesion: 0.50
Nodes (3): rootLockfile, rootManifest, webManifest

### Community 291 - "Apple App Icon"
Cohesion: 0.67
Nodes (3): Calm Green and Gold Palette, Talli Apple App Icon, Tally Mark Symbol

### Community 292 - "Application Icon"
Cohesion: 0.67
Nodes (3): Green Gold Brand Palette, Talli Brand Icon, Tally Mark Motif

### Community 294 - "Compatibility Baseline Schema"
Cohesion: 0.67
Nodes (3): pattern, type, path

### Community 295 - "Customer Ready Gate Evidence Schema"
Cohesion: 0.67
Nodes (3): format, type, executedAt

### Community 296 - "Customer Ready Gate Evidence Schema"
Cohesion: 0.67
Nodes (3): pattern, type, producerDigest

### Community 297 - "Customer Ready Gate Evidence Schema"
Cohesion: 0.67
Nodes (3): revision, pattern, type

### Community 298 - "Customer Ready Gate Evidence Schema"
Cohesion: 0.67
Nodes (3): startedAt, format, type

### Community 299 - "Customer Ready Gate Evidence Schema"
Cohesion: 0.67
Nodes (3): transcriptDigest, pattern, type

### Community 300 - "Customer Ready Gate Evidence Schema"
Cohesion: 0.67
Nodes (3): transcriptPath, pattern, type

### Community 303 - "Annual Accounts TT02 Evidence"
Cohesion: 0.67
Nodes (3): payloadHashes, companyAccounts, mainForm

### Community 304 - "Annual Accounts TT02 Evidence"
Cohesion: 0.67
Nodes (3): validation, hasErrors, issues

### Community 305 - "Company Tax TT02 Evidence"
Cohesion: 0.67
Nodes (3): localSchemaValidation, schemas, status

### Community 307 - "Customer Agreement Reacceptance"
Cohesion: 0.67
Nodes (3): backendOperatorSession(), listAuthorityOperations(), listLaunchSignoffs()

## Knowledge Gaps
- **2497 isolated node(s):** `schemaVersion`, `generatedAt`, `title`, `role`, `displayName` (+2492 more)
...
- **Why does `requestMaskinportenToken()` connect `Maskinporten Integration` to `Web Business Actions`, `Company Tax Return Authority Test`, `System User Flow`, `Authority Operations`, `Annual Accounts Authority`, `RF1086 Authority Test`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `createTalliApiClient()` connect `Company Access Administration` to `Company Access Administration`, `Generated API Client`?**
