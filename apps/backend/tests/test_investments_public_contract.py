...
def test_share_purchase_command_is_investment_owned_and_transport_free() -> None:
    from talli_backend.modules.investments import public
    from talli_backend.modules.investments.public import RecordSharePurchaseCommand
