...
{"apiOperations":["investmentsCorrectInvestment","investmentsListAcquisitionLots","investmentsListActivity","investmentsListCorrections","investmentsListEconomicEvents","investmentsListPositions","investmentsListShareSaleAllocations","investmentsRecognizeReceivedDividend","investmentsRecognizeReceivedFundDistribution","investmentsRecognizeSharePurchase","investmentsRecognizeShareSale","investmentsSettleCash"],"dependencies":[],"publicEntryPoints":["@/features/investments","apps/web/features/investments","apps/web/features/investments/index.ts"],"routes":["/actions/[type]","/workspace","/year-end"]}
-->

## Purpose and boundary

This feature submits owner-provided purchase, sale, share-dividend, and
fund-distribution recognition facts, settles their cash independently, and
submits correction facts. It reads canonical economic-event settlement state,
