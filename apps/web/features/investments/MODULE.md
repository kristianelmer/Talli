...
{"apiOperations":["investmentsListAcquisitionLots","investmentsListPositions","investmentsRecordSharePurchase"],"dependencies":[],"publicEntryPoints":["@/features/investments","apps/web/features/investments","apps/web/features/investments/index.ts"],"routes":["/actions/[type]","/workspace","/year-end"]}
-->

## Purpose and boundary

This feature submits owner-provided share-purchase facts and reads canonical
...
investment policy, select accounts, construct postings, allocate lots, or write
