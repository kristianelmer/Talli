...
| --- | --- | --- | --- | --- |
| Trademark search | Patentstyret search for `Talli`, close variants, similar accounting/finance software marks, relevant Nice classes | Not completed in official UI. Supplemental web search shows unrelated uses that require review. | Pending | Pending |
| Company-name conflict | Brønnøysund search for `Talli`, variants, confusingly similar accounting/finance company names | Not completed in official UI. | Pending | Pending |
