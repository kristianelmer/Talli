...
| Company tax return | Deterministic payload/XML, three official 2025 XSD checks, test-only Skatteetaten/Altinn transport client, and TT02 `validertOK` evidence; reconciliation handles supported admin costs, interest, exempt dividends/gains, non-deductible losses, and 3% inclusion | Add the two Altinn instance scopes, connect the transport to persisted filing state, complete TT02 instance/upload plus personal signing handoff and receipt/archive, and obtain dated approval. |
